...
console.log('Todennäköisyys sille että ' + age + ' vuoden ikäinen henkilö' +
     ' tilaa paperille painettua sanomalehteä on ' + proba.toFixed(2));
